...
if (!$video_has_audio) {
    $video_attributes = 'aria-label="Cette vidéo n\'a pas de piste audio" muted';
}
...
<div id="<?php echo esc_attr($id); ?>" class="alignfull <?php echo esc_attr($className); ?>">
    <div class="video-player" role="region" aria-label="Lecteur vidéo<?php echo !$video_has_audio ? ' sans audio' : ''; ?>" aria-describedby="transcript-<?php echo esc_attr($id); ?>">
        ...
        <div class="controls">
            <div>
                ...
                <?php endif; ?>
                <button class="transcript-toggle" aria-controls="transcript-<?php echo esc_attr($id); ?>" aria-expanded="false" aria-label="Afficher/Masquer la transcription">Transcription</button>
            </div>
            <div class="progress-container" role="slider" aria-label="Chronologie de la vidéo" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">
    ...
    <?php if ($transcript_content): ?>
        <div id="transcript-<?php echo esc_attr($id); ?>" class="transcript" hidden aria-labelledby="transcript-heading-<?php echo esc_attr($id); ?>">
            <h2 id="transcript-heading-<?php echo esc_attr($id); ?>" class="is-style-u-eyebrow-heading">Transcription</h2>
