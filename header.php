...
<a href="#c-page-footer" class="skip-link">Passer au pied de page</a>
  ...
  <div class="c-header-main">
    ...
    <div class="o-wrapper-wide  u-relative">
        ...
        <button href="#" id="open-modal-nav" class="c-modal-nav-button" aria-haspopup="true" aria-expanded="false" aria-label="Ouvrir le menu">
            ...
            <div class="c-lang-select  c-lang-select--mobile" role="navigation" aria-label="Sélecteur de langue">
          ...
          <div class="x-body-wrapper"></div>
            ...
            <nav class="c-modal-nav" aria-label="Menu de navigation mobile" role="navigation" itemscope itemtype="https://schema.org/SiteNavigationElement">
